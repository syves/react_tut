...
ListStore = {
  ...
  var loadRequest = $.ajax({
    type: 'GET',
    url: "https://listalous.herokuapp.com/lists/syves/"
  })
  ...
  addItem: function(itemDescription) {
    var creationRequest = $.ajax({
      type: 'POST',
      url: "http://listalous.herokuapp.com/lists/syves/items",
  ...
  type: 'PUT',
  url: "https://listalous.herokuapp.com/lists/syves/items/" + itemId,
